...
class ClassCourse
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\TeacherHasClass",mappedBy="classCourseClassCourse",cascade={"persist"})
     */
    private $classHasTeachers;
    ...
    public function __construct()
    {
        ...
        $this->classHasTeachers = new \Doctrine\Common\Collections\ArrayCollection();
    }
     ...
     * Add classHasTeacher
     *
     * @param \AppBundle\Entity\TeacherHasClass $classHasTeacher
     *
     * @return ClassCourse
     */
    public function addClassHasTeacher(\AppBundle\Entity\TeacherHasClass $classHasTeacher)
    {
        $this->classHasTeachers[] = $classHasTeacher;
     ...
     * @param \AppBundle\Entity\TeacherHasClass $classHasTeacher
     */
    public function removeClassHasTeacher(\AppBundle\Entity\TeacherHasClass $classHasTeacher)
    {
        $this->classHasTeachers->removeElement($classHasTeacher);
    }

    /**
     * Get classHasTeachers
     *
     * @return \Doctrine\Common\Collections\Collection
     */
    public function getClassHasTeachers()
    {
        return $this->classHasTeachers;
    }
}
